...
from data import REDataModule, Example, REDataset, collate_fn
...
def main(cfg: DictConfig) -> None:
    ...
    model = T5FineTuneModel(model_name=cfg.predict.t5.model)
    ...
    dataloader = DataLoader(predict_data, shuffle=False, pin_memory=True,
                            num_workers=cfg.predict.dataset.num_workers,
